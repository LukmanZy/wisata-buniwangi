...
<div class="col-lg-8">
    <form action="/dashboard/posts" method="post" enctype="multipart/form-data">
        ...
        <div class="mb-3">
          ...
          <input type="text" class="form-control @error('tiket') is-invalid @enderror" id="tiket" name="tiket" required autofocus value="{{ old('tiket') }}">
          @error('tiket')
              <div class="invalid-feedback">
                {{ $message }}
              </div>
        ...
        <div class="mb-3">
          ...
          <input type="text" class="form-control @error('loc') is-invalid @enderror" id="loc" name="loc" required autofocus value="{{ old('loc') }}">
        ...
        <div class="mb-3">
          ...
          <div id="lokasiHelp" class="form-text text-danger">*Maximal 2 MB</div>
        </div>
        @error ('image1')
        <div class="invalid-feedback">
          {{ $message }}
